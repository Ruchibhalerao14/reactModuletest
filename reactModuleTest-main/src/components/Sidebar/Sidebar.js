...
import "./Sidebar.css";
import MakeNotes from "../Make Notes/MakeNotesL";
import LptNotesTitle from "../Notes Title/LptNotesTitle";
  ...
  return (
    <div className="sidebar">
      ...
      <div className="sidebar_note_titles">
        {titles.length > 0 ? (
          titles.map((title, index) => <LptNotesTitle key={index} title={title} />)
        ) : (
          <div>
          </div>
        )}
