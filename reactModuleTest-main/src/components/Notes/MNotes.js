...
import MNotesCon from "../Notes Content/MNotesCon";
...
function MNotes() {
  ...
  useEffect(() => {
    ...
    const groupTitles = JSON.parse(localStorage.getItem("groupTitles"));
    const selectedGroup = groupTitles.find((group) => group.name === selected);
